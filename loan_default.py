...
model.fit(x_train,y_train)
pred=model.predict(x_train)
np.mean(pred==y_train)#96%

pred=model.predict(x_test)
np.mean(pred==y_test)#94.9%
model.score(x_test,y_test)
cross_val=cross_val_score(model,X,Y,cv=10,n_jobs=-1)
cross_val.mean()#mean accuracy of 93.6%
...
model.fit(x_train,y_train)
model.score(x_train,y_train)#96.04
model.score(x_test,y_test)#94.94
...
model.fit(x_train,y_train)
model.score(x_train,y_train)#97.14
model.score(x_test,y_test)#95.01
cross_val=cross_val_score(model,X,Y,cv=10,n_jobs=-1)
cross_val.mean()#mean accuracy of 93.72%
